$(document).ready(function () {
    ...
    $(".content .example.example5 ul li h3").on("click", function () {
    ...
    $(".example6 #a1").on("click", function () { myConsole.reloadSettings({ theme: "default" }); });
    $(".example6 #a2").on("click", function () { myConsole.reloadSettings({ theme: "clasic" }); });
    $(".example6 #a3").on("click", function () { myConsole.reloadSettings({ theme: "light" }); });

    var opacity = 1;
    $(".example6 #a4").on("click", function () {
        if (opacity > 0.9) return false;
        opacity += 0.1;

        myConsole.reloadSettings({ opacity: opacity });
    });
    $(".example6 #a5").on("click", function () {
    ...
    $(".example6 #a6").on("click", function () { myConsole.reloadSettings({ width: "100%", minWidht: 0 }); });
    $(".example6 #a7").on("click", function () { myConsole.reloadSettings({ width: "550px", minWidht: 0 }); });
